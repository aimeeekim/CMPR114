...
class MyGUI:
    ...
    def __init__(self):
        ...
        self.label3 = tkinter.Label(self.main_window, text='You never fail until you stop trying.', borderwidth=1, relief='solid')
        self.label4 = tkinter.Label(self.main_window, text='Happiness is not by chance, but by choice.', borderwidth=1, relief='solid')
